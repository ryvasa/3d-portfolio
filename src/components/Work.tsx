  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-4/5  relative z-[2]  flex justify-center items-center "
      >
          ...
          {expirience.map((exp, index) => (
            <li key={index}>
              ...
              <motion.div
                ...
                transition={{ delay: index, duration: 0.7, ease: "easeInOut" }}
                className={`${
                  index % 2 !== 0
                    ? "timeline-end"
                    : "timeline-start  md:text-end"
                } my-5 rounded-xl bg-dark-lg/50 backdrop-blur-sm p-4 shadow-sm lg:w-[500px] w-full  `}
              >

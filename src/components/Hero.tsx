...
const Hero = (): JSX.Element => {
  ...
  const translateYToTop = useTransform(scrollYProgress, [0, 1], [-50, -100]);
  return (
    <div
      id="home"
    ...
    >
      <div className="w-full h-full relative">
            ...
            <li className="group transition-all w-fit lg:w-full">
              ...
              >
                <div className="flex gap-2 justify-start items-center">
                  ...
                  <p className="text-font-primary text-xs lg:text-md font-semibold">
                    ryvasa
                  </p>
                </div>
        ...
        >
          <BackgroundBeams />
          {/* <MoonCanvas onLoad={() => setIsLoaded(true)} /> */}
        </motion.div>
      </div>
    </div>
  );

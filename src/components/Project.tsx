  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <p className="font-normal text-base max-w-lg text-neutral-200">
        This application is an online shop, users can view items for sale, add
        them to their cart, and also place orders.
      </p>
      <div className="flex flex-col gap-1">
...
const SkeletonThree = () => {
  return (
    <div className="flex flex-col gap-1">
      ...
      <p className="font-normal text-base max-w-lg text-neutral-200">
        This application has functions like social media in general, such as
        making posts, and giving likes and comments, apart from that, users can
        also connect with other users with the realtime chat feature.
      </p>
      <div className="flex flex-col gap-1">
        <p className="text-dark-xs font-semibold">Build with</p>
        <div className="gap-2 flex">
